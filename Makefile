...
HASHTABLE_BUILD_OBJS=hashtable/build/Split-Ordered-Lists.o hashtable/build/stacks.o hashtable/build/bistack.o hashtable/build/bichannel.o hashtable/build/gpu-channel-item-allocator.o hashtable/build/hashtable-memory-manager.o hashtable/build/Micheal-Lock-Free-List.o hashtable/build/splay-uint64.o
BENCHMARK_BUILD_OBJS=benchmark/build/benchmark.o benchmark/build/splay-tree-benchmark.o benchmark/build/Split-Ordered-Lists-benchmark.o
